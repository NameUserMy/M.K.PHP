...
<form id='country' method="post">
	<select name="countryid" id='countryOpt' class="col-sm-3 col-md-3 col-lg-3">
		<option value="0">Select country...</option>
	</select>
	<select name="cityid" id='cityOpt' class="col-sm-3 col-md-3 col-lg-3">
		<option value="0">Select city...</option>
	</select>
</form>
<table id='all-info' width="100%" class="table table striped tbtours text-center">
</table><br>
